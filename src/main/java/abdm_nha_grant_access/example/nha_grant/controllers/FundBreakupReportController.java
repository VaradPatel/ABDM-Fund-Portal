...
import abdm_nha_grant_access.example.nha_grant.service.FundBreakupReportService;
...
@RestController
@RequestMapping("/fund-breakup")
@Slf4j
public class FundBreakupReportController {

    @Autowired
    private FundBreakupReportService fundBreakupReportService;
    ...
    public ResponseEntity<?> uploadReport(
        ...
        try {
            FundBreakupReportService.UploadResult result =
                    fundBreakupReportService.uploadReport(file, date, financialYear, quarter);
    ...
    public ResponseEntity<?> downloadLatest() {
        try {
            FundBreakupReportFile file = fundBreakupReportService.getLatestFile();
    ...
    public ResponseEntity<?> getSummary(
        ...
        try {
            List<StateFundBreakupSummary> summary = fundBreakupReportService
